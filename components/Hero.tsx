    ...
    <section className="w-full h-[calc(100svh-216px)] max-h-150 lg:max-h-[calc(100vh-216px)] relative">
      ...
      <div className="absolute top-0 left-0 right-0 bottom-0 flex items-center bg-black/50">
        <div className="container_width flex flex-col gap-7 md:gap-10">
          ...
          {/* Section Description */}
          <p className="text-xs tracking-widest font-mono leading-6 sm:leading-8 text-gray-100">
            Join Powerfit today and transform your <br className="hidden " />{" "}
            body and mind with our expert trainers{" "}
            <br className="hidden lg:flex" /> and state-of-the-art facilities.
          </p>
